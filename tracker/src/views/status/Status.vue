...
<div class="bg-dark">
    ...
    <button class="btn btn-primary" @click="ExibirEditor">
        {{TextoBotao}}
    </button>

    <form action="" v-on:submit.prevent="FormStatus">

        <h2>Cadastrar</h2>

        <Input label="Nome do Status" v-model="name" placeholder="Digite o nome do status" />
    ...
    <div v-for="nameStatus in status" :key="nameStatus.id" :value="nameStatus.id">
        <form @submit.prevent="getStatus" v-on:change="EditStatus($event,nameStatus.id)">
            ...
            <div>
                ...
                <div v-show="EditarStatus">
                    ...
                    <div>
                        <button class="btn btn-danger" @click="deleteDado(nameStatus.id)">
                            Deletar
                        </button>
